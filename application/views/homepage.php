                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                                <div class="images_box">
                                    <figure><img src="assets/images/img2.png"></figure>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="box_bg">
          <div class="box_bg_img">
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="assets/images/my1.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="assets/images/my2.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="assets/images/my3.jpg"></figure>
                  <div class="overlay">
                    <h3>Skills</h3>
                    <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="assets/images/my4.jpg"></figure>
                  <div class="overlay">
...
<div id="learn" class="learn">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="learn_box">
          <figure><img src="assets/images/img.jpg" alt="img"/></figure>
        </div>
      </div>
    </div>
  </div>
...
<div class="make">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
          <figure><img src="assets/images/make_img.jpg"></figure>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="assets/icon/loc.png" alt="#" /></a>London 145
                        <br>United Kingdom </li>
                        <li>
                          <a href="#"><img src="assets/icon/email.png" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="assets/icon/call.png" alt="#" /></a>+12586954775 </li>
                          </ul>
                          <ul class="social_link">
                            <li><a href="#"><img src="assets/icon/fb.png"></a></li>
                            <li><a href="#"><img src="assets/icon/tw.png"></a></li>
                            <li><a href="#"><img src="assets/icon/lin(2).png"></a></li>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="index.html"> <img src="assets/images/logo1.jpg" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
